...
book_same_author = {"ISBN": "0061002828",
...
def test_create_book_record_same_author():
    create_book_record(book)
    create_book_record(book_same_author)
    book_1 = json.loads(read_full_book_record(book['ISBN']))
    book_2 = json.loads(read_full_book_record(book_same_author['ISBN']))
    assert book_1['Author_ID_1'] == book_2['Author_ID_1']
    assert book_1['Author_First_Name_1'] == book_2['Author_First_Name_1']
    assert book_1['Author_Last_Name_1'] == book_2['Author_Last_Name_1']